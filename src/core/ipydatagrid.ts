...
import {
  CellRenderer
} from '@phosphor/datagrid/lib/cellrenderer';

import {
  DataModel
} from '@phosphor/datagrid/lib/datamodel';
...
import {
  TextRenderer
} from '@phosphor/datagrid/lib/textrenderer';
...
class DataGrid extends Widget {
  ...
  /**
   * Get the context menu for the data grid.
   */
  get contextMenu(): GridContextMenu | null {
    return this._contextMenu;
  }

  set contextMenu(menu: GridContextMenu | null) {

    if (menu) {
      this.cellClick.connect(menu.open)
    }
  ...
  private _contextMenu: GridContextMenu | null = null;
}
