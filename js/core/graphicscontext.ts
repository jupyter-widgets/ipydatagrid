...
class GraphicsContext implements IDisposable {
  ...
  createImageData() {
    return this._context.createImageData.apply(this._context, arguments as any);
  }
  ...
  putImageData(): void {
    this._context.putImageData.apply(this._context, arguments as any);
  }
  ...
  drawImage(): void {
    this._context.drawImage.apply(this._context, arguments as any);
  }
