...
test.describe('ipydatagrid Visual Regression', () => {
  ...
  test('Light theme: Check ipydatagrid first renders', async ({
    page,
    tmpPath,
  }) => {
  ...
  test('Dark theme: Check ipydatagrid first renders', async ({
    page,
    tmpPath,
  }) => {
  ...
  test('Light theme: Check ipydatagrid update plot properties', async ({
    page,
    tmpPath,
  }) => {
  ...
  test('Dark theme: Check ipydatagrid update plot properties', async ({
    page,
    tmpPath,
  }) => {
